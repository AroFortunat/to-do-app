...
const ImportantNotUrgent = () => {
    return (
        <div className='max-h-screen h-1/2'>
            <article className="rounded-xl border border-gray-600 ">
                <div className="flex bg-gray-600 items-center p-5 rounded-t-xl gap-4">
                    <div className='w-10 h-10 border-2 flex items-center justify-center rounded-full'>
                        <span className='text-white font-bold'>3</span>
                    </div>                    <div>
                        <h3 className="text-lg font-medium text-white">Important Not Urgent</h3>

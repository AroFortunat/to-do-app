...
const NotImportantAndNotUrgent = () => {
    return (
        <div className='max-h-screen h-1/2'>
            <article className="rounded-xl border border-green-800 ">
                <div className="flex bg-green-800 items-center p-5 rounded-t-xl gap-4">
                    <div className='w-10 h-10 border-2 flex items-center justify-center rounded-full'>
                        <span className='text-white font-bold'>4</span>
                    </div>                    <div>
                        <h3 className="text-lg font-medium text-white">Not Important Not Urgent</h3>
...
export default NotImportantAndNotUrgent
